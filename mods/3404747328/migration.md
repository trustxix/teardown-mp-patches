...
-	RegisterTool("rmwm249", "M249", "MOD/prefab/minigun.xml")
-	SetBool("game.tool.rmwm249.enabled", true)
-
-	angle = 0
-	angVel = 0
-	coolDown = 0
...
-	SetToolHaptic("rmwm249", toolHaptic);
-
-	
-	oldPipePos = Vec()
-	particleTimer = 0
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwm249" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
...
+    RegisterTool("rmwm249", "M249", "MOD/prefab/minigun.xml")
+    SetBool("game.tool.rmwm249.enabled", true, true)
+    angle = 0
+    angVel = 0
+    coolDown = 0
+    smoke = 0
