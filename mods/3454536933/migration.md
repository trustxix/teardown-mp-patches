...
-	RegisterTool("rmwsa80", "SA80", "MOD/prefab/minigun.xml")
-	SetBool("game.tool.rmwsa80.enabled", true)
-
-	angle = 0
-	angVel = 0
-	coolDown = 0
...
-	SetToolHaptic("rmwsa80", toolHaptic);
-
-	
-	oldPipePos = Vec()
-	particleTimer = 0
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwsa80" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
...
+    RegisterTool("rmwsa80", "SA80", "MOD/prefab/minigun.xml")
+    SetBool("game.tool.rmwsa80.enabled", true, true)
+    angle = 0
+    angVel = 0
+    coolDown = 0
+    smoke = 0
