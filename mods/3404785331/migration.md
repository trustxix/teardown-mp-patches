...
+++ patched/main.lua
@@ -1,102 +1,13 @@
---rmwm110sass custom tool example
-
...
-	RegisterTool("rmwm110sass", "M110 SASS", "MOD/prefab/minigun.xml")
-	SetBool("game.tool.rmwm110sass.enabled", true)
-
-	angle = 0
-	angVel = 0
-	coolDown = 0
...
-	SetToolHaptic("rmwm110sass", toolHaptic);
-
-	
-	oldPipePos = Vec()
-	particleTimer = 0
...
+tion tick(dt)
 	...
 	--Check if rmwm110sass is selected
@@ -185,7 +94,7 @@
 		local d = GetToolBody()
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwm110sass" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
...
+    RegisterTool("rmwm110sass", "M110 SASS", "MOD/prefab/minigun.xml")
+    SetBool("game.tool.rmwm110sass.enabled", true, true)
+    angle = 0
+    angVel = 0
+    coolDown = 0
+    smoke = 0
