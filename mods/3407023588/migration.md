...
-	RegisterTool("rmwmk18", "MK18", "MOD/prefab/minigun.xml")
-	SetBool("game.tool.rmwmk18.enabled", true)
-
-	angle = 0
-	angVel = 0
-	coolDown = 0
...
-	SetToolHaptic("rmwmk18", toolHaptic);
-
-	
-	oldPipePos = Vec()
-	particleTimer = 0
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwmk18" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
...
+    RegisterTool("rmwmk18", "MK18", "MOD/prefab/minigun.xml")
+    SetBool("game.tool.rmwmk18.enabled", true, true)
+    angle = 0
+    angVel = 0
+    coolDown = 0
+    smoke = 0
