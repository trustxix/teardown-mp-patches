...
-	okpsprite = LoadSprite("MOD/sprites/okpsprite.png")
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwak74m" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
