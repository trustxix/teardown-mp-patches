...
+
+        			if twitchVoteStep == 1 then
+        				SetInt(moddataPrefix .. "TwitchVoteStep", 2, true)
+        				twitchVoteStep = 2
+        			else
+        				SetInt(moddataPrefix .. "TwitchVoteStep", 1, true)
+        				twitchVoteStep = 1
+        			end
+        		else
+        			triggerChaos()
...
# Migration Report: quickload.lua
...
```diff
--- original/quickload.lua
+++ patched/quickload.lua
@@ -1,7 +1,10 @@
...
+		SetString(moddataPrefix.. "DisabledEffects", SerializeTable(chaosEffects.disabledEffects), true)
 	end
 
 	if saveVersion < 4 then
 		saveVersion = 4
-		SetInt(moddataPrefix .. "Version", 4)
+		SetInt(moddataPrefix .. "Version", 4, true)
...
+		SetInt(moddataPrefix .. "Version", 5, true)
...
+		SetInt(moddataPrefix .. "Version", 6, true)
...
+		SetInt(moddataPrefix .. "Version", 7, true)
 
 		twitchIntegration = false
-		SetBool(moddataPrefix .. "TwitchIntegration", twitchIntegration)
+		SetBool(moddataPrefix .. "TwitchIntegration", twitchIntegration, true)
 	end
 	
 	if saveVersion < 8 then
 		saveVersion = 8
-		SetInt(moddataPrefix .. "Version", 8)
+		SetInt(moddataPrefix .. "Version", 8, true)
 
 		twitchBalancing = 1
-		SetFloat(moddataPrefix .. "TwitchBalancing", twitchBalancing)
+		SetFloat(moddataPrefix .. "TwitchBalancing", twitchBalancing, true)
 	end
...
+		SetInt(moddataPrefix .. "Version", 9, true)
