...
-    regSetBool('tool.particlesOn', true)
-    regSetBool('tool.showAbilityText', true)
-    regSetBool('tool.showAbilityIcon', true)
-    regSetBool('tool.showSelectionOutline', true)
-    regSetBool('tool.clearSelectionOnEnchant', true)
-    regSetBool('tool.clearSelectionOnDisenchant', true)
+    regSetInt('tool.range'     , 0, true)
+    regSetBool('tool.debugMode', false, true)
+    regSetBool('tool.soundOn', true, true)
+    regSetBool('tool.particlesOn', true, true)
+    regSetBool('tool.showAbilityText', true, true)
+    regSetBool('tool.showAbilityIcon', true, true)
+    regSetBool('tool.showSelectionOutline', true, true)
+    regSetBool('tool.clearSelectionOnEnchant', true, true)
+    regSetBool('tool.clearSelectionOnDisenchant', true, true)
 
     -- Key bindings
     regInitKey('key.enchant', "lmb")
@@ -45,21 +46,22 @@
...
-
-        input = {
-            didStartSpell = function() return tool.tool.active() and InputPressed(regGetString('key.enchant')) end,
-            didStopSpell = function() return tool.tool.active() and InputReleased(regGetString('key.enchant')) end,
-            didStartRemove = function() return tool.tool.active() and InputPressed(regGetString('key.disenchant')) end,
-            didStopRemove = function() return tool.tool.active() and InputReleased(regGetString('key.disenchant')) end,
-            didStartClear = function() return tool.tool.active() and InputPressed(regGetString('key.clear')) end,
-            didStopClear = function() return tool.tool.active() and InputReleased(regGetString('key.clear')) end,
-            didStartSelection = function() return tool.tool.active() and InputPressed(regGetString('key.select')) end,
-            didStopSelection = function() return tool.tool.active() and InputReleased(regGetString('key.select')) end,
-            didStartUpdateFast = function() return tool.tool.active() and InputPressed(regGetString('key.updateFast')) end,
-            didStopUpdateFast = function() return tool.tool.active() and InputReleased(regGetString('key.updateFast')) end,
-            didStartUpdateSlow = function() return tool.tool.active() and InputPressed(regGetString('key.updateSlow')) end,
-            didStopUpdateSlow = function() return tool.tool.active() and InputReleased(regGetString('key.updateSlow')) end,
-            getScroll = function() return tool.tool.active() and InputValue( "mousewheel" ) or 0 end,
-        },
-
-        setup = {
-            name = 'enchantments',
...
@@ -121,7 +78,6 @@
     if tool.tool.input.didStopUpdateSlow() then -- Relesed update slow
         tool.ability.updatingSlow = false
     end
-
...
@@ -183,7 +139,7 @@
     ...
     if tool.ability.updatingFast or tool.ability.updatingSlow then -- Block tool change on mouse wheel update
...
-        {
-            name = "Unbreakable",
-            icon = "MOD/img/unbreakable.png",
-            color = Vec(178/255,179/255,183/255)
-        },
-        {
-            name = "Explosive",
-            icon = "MOD/img/explosive.png",
-            level = 1,
-            levelMin = 0.5,
-            levelMax = 4,
-            color = Vec(249/255,182/255,78/255)
-        },
-        {
-            name = "Fragile",
-            icon = "MOD/img/fragile.png",
-            color = Vec(245/255,218/255,189/255)
-        },
-        {
-            name = "Decaying",
-            icon = "MOD/img/decaying.png",
-            level = 0.1,
-            levelMin = 0.1,
-            levelMax = 5,
-            color = Vec(76/255,122/255,91/255)
-        },
-        {
-            name = "Slow",
-            icon = "MOD/img/slow.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 10,
-            color = Vec(65/255, 91/255, 113/255)
-        },
-        {
-            name = "Charmed",
-            icon = "MOD/img/charmed.png",
-            level = 5,
-            levelMin = 1,
-            levelMax = 10,
-            color = Vec(138/255,31/255,109/255)
-        },
-        {
-            name = "Feared",
-            icon = "MOD/img/feared.png",
-            level = 5,
-            levelMin = 1,
-            levelMax = 10,
-            color = Vec(47/255,35/255,35/255)
-        },
-        {
-            name = "Petrified",
-            icon = "MOD/img/petrified.png",
-            color = Vec(49/255, 49/255, 49/255)
-        },
-        {
-            name = "Iced",
-            icon = "MOD/img/iced.png",
-            color = Vec(32/255,195/255,208/255)
-        },
-        {
-            name = "Wet",
-            icon = "MOD/img/wet.png",
-            color = Vec(215/255, 143/255, 238/255)
-        },
-        {
-            name = "Ignited",
-            icon = "MOD/img/ignited.png",
-            color = Vec(1,69/255,23/255)
-        },
-        {
-            name = "Bouncy",
-            icon = "MOD/img/bouncy.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 2,
-            color = Vec(104/255,0/255,1)
-        },
-        {
-            name = "Attractive",
-            icon = "MOD/img/attractive.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 10,
...
-        {
-            name = "Gravity",
-            icon = "MOD/img/gravity.png",
-            level = 0,
-            levelMin = -10,
-            levelMax = 10,
-            color = Vec(95/255, 109/255, 183/255)
-        },
-        {
-            name = "Spinny",
-            icon = "MOD/img/spinny.png",
-            level = 1,
-            levelMin = -10,
-            levelMax = 10,
-            color = Vec(226/255, 193/255, 150/255)
-        },
-        {
-            name = "Rolly",
-            icon = "MOD/img/rolly.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 10,
-            color = Vec(36/255, 36/255, 36/255)
-        },
-        {
-            name = "Shaky",
-            icon = "MOD/img/shaky.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 10,
-            color = Vec(1, 157/255, 0)
-        },
-        {
-            name = "Unstable",
-            icon = "MOD/img/unstable.png",
-            level = 1,
-            levelMin = 0.1,
-            levelMax = 10,
-            color = Vec(11/255, 12/255, 49/255)
-        }
-    },
-    indexByName = {},
-    indexByTag= {},
...
-    updatingFast = false,
-    updatingSlow = false,
-    disenchantAllTimer = 0,
-    clearAllTimer = 0,
-    decayIndex = 1,
-    shapesSelection={},
-    shapesSelectionCount = 0,
...
-    tool.ability.indexByTag[string.lower(item.name)] = i
-end
-
 function tool.ability.getSelected()
     return tool.ability.list[tool.ability.selected]
 end
@@ -664,7 +457,7 @@
     end
 
     local decayingBodies = FindBodies("decaying", true)
-    if #decayingBodies > 0 then
+    if #decayingBodies ~= 0 then
         if tool.ability.decayIndex > #decayingBodies then
             tool.ability.decayIndex = 1
         end
@@ -717,7 +510,7 @@
             local charmMaxDist = charmedItem.levelMin + charmedItem.levelMax
             local charmDist = charmMaxDist - tonumber(GetTagValue(body, "charmed"))
             local distToLimit = distToPlayer - radius - charmDist
-            if distToLimit > 0 then
+            if distToLimit ~= 0 then
                 local vel = GetBodyVelocity(body)
                 local dir = VecSub(playerPos, center)
                 local newVel = VecAdd(vel, VecResize(dir, ((movementForce * 10) + (distToLimit/10)) * GetTimeStep()))
@@ -1185,7 +978,7 @@
 end
 
 function tool.ability.disenchantAll()
-    if tool.ability.disenchantAllTimer > 0 then
+    if tool.ability.disenchantAllTimer ~= 0 then
         tool.ability.disenchantAllTimer = tool.ability.disenchantAllTimer - GetTimeStep()
         return
     end
@@ -1256,7 +1049,7 @@
 end
 
 function tool.ability.clearAll()
-    if tool.ability.clearAllTimer > 0 then
+    if tool.ability.clearAllTimer ~= 0 then
         tool.ability.clearAllTimer = tool.ability.clearAllTimer - GetTimeStep()
         return
     end
@@ -1405,4 +1198,5 @@
     -- Compute local transform from current world transform
     local localTransform = TransformToLocalTransform(GetBodyTransform(newBody), GetShapeWorldTransform(shape))
     SetShapeBody(shape, newBody, localTransform)
-end+end
+
...
-            do UiPush()
-
-                ui.slider.create('Max enchant distance (0 = infinite)', 'tool.range', 'Meters', 0, 100, nil, nil, nil, nil, true)
-                ui.padding.create(0, 30)
-
-                ui.checkBox.create('Show enchantment type', 'tool.showAbilityText')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Show enchantment icon', 'tool.showAbilityIcon')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Show selection outline', 'tool.showSelectionOutline')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Clear selection on enchant', 'tool.clearSelectionOnEnchant')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Clear selection on disenchant', 'tool.clearSelectionOnDisenchant')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Particles', 'tool.particlesOn')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-            ui.keyBinding.create('Enchant target', 'key.enchant', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Disenchant target (hold for all)', 'key.disenchant', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Clear current enchantment (hold for all)', 'key.clear', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Change enchantment (hold)', 'key.pattern', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Add/remove to selection (hold for many)', 'key.select', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('+/- 1 enchantment level', 'key.updateFast', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('+/- 0.1 enchantment level', 'key.updateSlow', true)
-            ui.padding.create(0, 50)
...
-            UiFont('regular.ttf', font_normal)
-            ui.padding.create(0, 50)
-            UiText('- Different enchantments can be applied to the same object', true)
-            ui.padding.create(0, 50)
-            UiText('- Some enchantements have a configurable level which determines how strong it is', true)
-            ui.padding.create(0, 50)
-            UiText('- Applying the same enchantement on an object twice will only update its level', true)
-            ui.padding.create(0, 50)
-            UiText('- Some enchantments may lag if applied to too many objects', true)
-            ui.padding.create(0, 50)
-            UiText('- The object you enchanted got launched into oblivion?', true)
-            UiText('  You can still use the clear button to remove its enchantments', true)
-            ui.padding.create(0, 100)
-
-        UiPop() end
-        
...
---- Draw spell type above tool name.
 function uiDrawSpellType()
     ...
     local textShown = regGetBool('tool.showAbilityText')
@@ -366,7 +246,7 @@
...
---- Draw enchantments of pointed body
 function uiDrawEnchantments()
     local body = GetShapeBody(tool.tool.aimShape)
     if not tool.ability.canBeEnchanted(body) then
@@ -543,7 +422,6 @@
     UiPop()
 end
