# Migration Report: internal\script_defs.lua
...
```diff
--- original/internal\script_defs.lua
+++ patched/internal\script_defs.lua
@@ -1,454 +1,60 @@
----@meta _
-
----@class TVec
...
+function GetPlayerTransform(playerId, includePitch) return Transform() end
+
...
+function GetPlayerRigWorldTransform(playerId) return nil end
+
...
---copy above files and include them in your mod to be able to register
---your weapon(s) in ProBallistics
-
-#include "src/assault-pack1.lua"
-]]
-
-function init()
+#version 2
...
---More info/faqs coming soon
```

---

# Migration Report: src\ar10.lua
...
```diff
--- original/src\ar10.lua
+++ patched/src\ar10.lua
@@ -1,58 +1 @@
-_weaponAR10   = "pb_ar10"
-
-AR10          =
...
-    aimOffsets   = { --add 3rd peson offsets later
-        [_aimPoseShoulder] = { x = -.05, y = .15, z = -.05, tilt = 0},
-        [_aimPoseIron] = { x = -.325, y = .175, z = -.15, tilt = 0, fov = 65, dof = 1, zoomDof = 1.25 },
-        [_aimPoseIronSideways] = { x = -.5, y = -.245, z = -.15, tilt = 55, fov = 50, dof = .25, zoomDof = .35 },
-    },
-    holoEnabled  = 1,
-    elements     = {
-        barrel = {
...
-    effects      = 1,
-    ammo         = {
-        [_munition5_56mmFMJ_CTR] = {
-            size   = 48,
-            reload = 1.75,
-        },
-        [_munition5_56mmFMJT_CTR] = {
-            size   = 48,
-            reload = 1.75,
-        },
-        [_munition5_56mmAP_CTR] = {
-            size   = 48,
-            reload = 1.75,
-        },
-    },
...
# Migration Report: src\ar15p.lua
...
```diff
--- original/src\ar15p.lua
+++ patched/src\ar15p.lua
@@ -1,62 +1 @@
-_weaponAR15P = "pb_ar15p"
-
-AR15P        =
-{
-    holoEnabled  = 1,
-    aimOffsets   = {
-        [_aimPoseShoulder] = { x = -.05, y = .15, z = .1, tilt = 0 },
-        [_aimPoseIron] = { x = -.325, y = .15, z = -.1, tilt = 0, fov = 55, sway = .25, dof = 1, zoomDof = 1.5 },
-        [_aimPoseIronSideways] = { x = -.5, y = -.25, z = -.1, tilt = 55, fov = 45, sway = .2, dof = .5, zoomDof = .75 },
-    },
-    aimPoses     = {
-        _aimPoseShoulder,
-        _aimPoseIronSideways,
...
-    barrelOffset = Vec(0.325, -0.375, -1.26),
-    redDotOffset = Transform(Vec(0.225, -0.375, -1.11)),
...
# Migration Report: src\ar15s.lua
...
```diff
--- original/src\ar15s.lua
+++ patched/src\ar15s.lua
@@ -1,95 +1 @@
-_weaponAR15S = "pb_ar15s"
-
-AR15S        =
-{
-    holoEnabled  = 1,
...
-        _aimPoseIron,
-    },
-    --scopeSprite=LoadSprite("img/scope_PNG13058.png"),
-    aimOffset    = { x = 0, y = .2, z = 0, tilt = 0, fov = 90 },
-    redDot               = _falseValue,
-    aimOffsets   = {
-        [_aimPoseShoulder] = {
...
-                QuatEuler(90, 0, 0)
-            ),
-            img = "MOD/img/hud/scope_PNG13058.png",
-        },
-        barrel = {
-            transform = Transform(
-                Vec(.3, -.4, -.7),
...
-    },
-
-    barrelOffset = Vec(0.325, -0.375, -1.41),
-    fireModes    = { 1, 0 },
-    fireMode     = 0,
-    ammo         = {
-        [_munition5_56mmFMJ_EPR] = {
-            size   = 30,
-            reload = 2,
-        },
-        [_munition5_56mmFMJT_EPR] = {
-            size   = 30,
-            reload = 2,
-        },
-        [_munition5_56mmAP_EPR] = {
-            size   = 30,
-            reload = 2,
-        },
-    },
...
# Migration Report: src\ar16sx.lua
...
```diff
--- original/src\ar16sx.lua
+++ patched/src\ar16sx.lua
@@ -1,104 +1 @@
-_weaponAR16SX = "pb_ar16sx"
-
-AR16SX        =
-{
-    aimPoses     = {
...
-        }
-    },
-    barrelOffset = Vec(0.325, -0.375, -1.66),
-    effects      = 3,
-    fireModes    = { 1 },
-    fireMode     = 1,
-    ammo         = {
...
# Migration Report: src\assault-pack1.lua
...
```diff
--- original/src\assault-pack1.lua
+++ patched/src\assault-pack1.lua
@@ -1,10 +1,4 @@
---[[
-#include "ar10.lua"
-#include "ar15p.lua"
...
-
+#version 2
 function initAssaultPack1()
     DebugPrint("AssaultPack1:Initializing")
     registerHandHeldWeapon(_weaponAR10, "AR10", "MOD/vox/AR10.vox", "2", AR10)
@@ -13,3 +7,4 @@
     registerHandHeldWeapon(_weaponAR16SX, "AR16-SX", "MOD/vox/AR16SX.vox", "3", AR16SX)
     DebugPrint("AssaultPack1:Initialized")
 end
+
