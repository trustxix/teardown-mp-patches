...
-#include "scripts/sword.lua"
-#include "scripts/master.lua"
...
# Migration Report: scripts\master.lua
...
```diff
--- original/scripts\master.lua
+++ patched/scripts\master.lua
@@ -1,226 +1,8 @@
-Master = {
-    stance = {
-        selected = 1,
...
-            {
-               name = "Stars",
-               icon = "MOD/img/stars.png",
-               color = Vec(190/255.0,169/255.0,222/255.0)
-            },
-            {
-                name = "Planets",
-                icon = "MOD/img/planets.png",
-                color = Vec(255/255.0,90/255.0,0/255.0)
-            },
-            {
-                name = "Sun",
-                icon = "MOD/img/sun.png",
-                color = Vec(255/255.0,236/255.0,0/255.0)
-            },
-            {
-                name = "Moon",
-                icon = "MOD/img/moon.png",
-                color = Vec(229/255.0,229/255.0,229/255.0)
-            },
-            {
-                name = "Earth",
-                icon = "MOD/img/earth.png",
-                color = Vec(76/255.0,76/255.0,176/255.0)
-            },
-            {
-                name = "Lotus",
-                icon = "MOD/img/lotus.png",
-                color = Vec(161/255.0,216/255.0,209/255.0)
-            },
-            {
-                name = "Pond",
-                icon = "MOD/img/pond.png",
-                color = Vec(1/255.0,164/255.0,243/255.0)
-            },
-            {
-                name = "Forest",
-                icon = "MOD/img/forest.png",
-                color = Vec(193/255.0,223/255.0,81/255.0)
-            },
-            {
-                name = "Supernova",
-                icon = "MOD/img/supernova.png",
-                color = Vec(60/255.0,16/255.0,140/255.0)
-            },
-            {
-                name = "Ouroboros",
-                icon = "MOD/img/ouroboros.png",
-                color = Vec(41/255.0,39/255.0,62/255.0)
-            },
-            {
-                name = "Pufferfish",
-                icon = "MOD/img/pufferfish.png",
-                color = Vec(205/255.0,142/255.0,81/255.0)
-            },
-            {
-                name = "Flock",
-                icon = "MOD/img/flock.png",
-                color = Vec(233/255.0,245/255.0,244/255.0)
-            },
-            {
-                name = "Vortex",
-                icon = "MOD/img/vortex.png",
-                color = Vec(137/255.0,154/255.0,159/255.0)
-            },
-            {
-                name = "Angel",
-                icon = "MOD/img/angel.png",
-                color = Vec(253/255.0,255/255.0,216/255.0)
-            }
-        }
-    },
-    attack = {
...
-            {
-               name = "Wasp Stinger",
-               icon = "MOD/img/wasp.png",
-               color = Vec(251/255.0,253/255.0,18/255.0)
-            },
-            {
-                name = "Darts Volley",
-                icon = "MOD/img/darts.png",
-                color = Vec(23/255.0,66/255.0,19/255.0)
-            },
-            {
-                name = "Zenith",
-                icon = "MOD/img/zenith.png",
-                color = Vec(98/255.0,76/255.0,184/255.0)
-            },
-            {
-                name = "Hummingbirds",
-                icon = "MOD/img/hummingbirds.png",
-                color = Vec(141/255.0,170/255.0,23/255.0)
-            },
-            {
-                name = "Sea Dragon",
-                icon = "MOD/img/dragon.png",
-                color = Vec(69/255.0,28/255.0,117/255.0)
-            },
-            {
-                name = "Silver Rain",
-                icon = "MOD/img/rain.png",
-                color = Vec(223/255.0,223/255.0,230/255.0)
-            },
-            {
-                name = "Holy Hand",
-                icon = "MOD/img/hand.png",
-                color = Vec(255/255.0,244/255.0,184/255.0)
-            },
-            {
-                name = "Endless Flow",
-                icon = "MOD/img/loop.png",
-                color = Vec(10/255.0,35/255.0,94/255.0)
-            },
-            {
-                name = "Judgement",
-                icon = "MOD/img/vrain.png",
-                color = Vec(255/255.0,184/255.0,184/255.0)
-            },
-            {
-                name = "Titan Stab",
-                icon = "MOD/img/stab.png",
-                color = Vec(223/255.0,92/255.0,77/255.0)
-            },
-            {
-                name = "Titan Thrust",
-                icon = "MOD/img/thrust.png",
-                color = Vec(255/255.0,183/255.0,74/255.0)
-            },
-            {
-                name = "Titan Drill",
-                icon = "MOD/img/drill.png",
-                color = Vec(127/255.0,121/255.0,121/255.0)
-            },
-            {
-                name = "Titan Swing",
-                icon = "MOD/img/swing.png",
-                color = Vec(163/255.0,21/255.0,21/255.0)
-            },
-            {
-                name = "Titan Slash",
-                icon = "MOD/img/slash.png",
-                color = Vec(52/255.0,235/255.0,201/255.0)
-            },
-            {
-                name = "Titan Smash",
-                icon = "MOD/img/smash.png",
-                color = Vec(63/255.0,87/255.0,129/255.0)
-            },
-            {
-                name = "Titan Crush",
-                icon = "MOD/img/crush.png",
-                color = Vec(222/255.0,255/255.0,254/255.0)
-            },
-            {
-                name = "Titan Wave",
-                icon = "MOD/img/wave.png",
-                color = Vec(47/255.0,0/255.0,255/255.0)
-            },
-            {
-                name = "Titan Spin",
-                icon = "MOD/img/spin.png",
-                color = Vec(141/255.0,117/255.0,107/255.0)
-            }
-        }
-    },
-    sounds = {
-        summon = LoadSound("MOD/snd/summon.ogg"),
-        unsummon = LoadSound("MOD/snd/unsummon.ogg"),
-        assemble = LoadLoop("MOD/snd/assemble.ogg", 1000),
-        split = LoadSound("MOD/snd/split.ogg", 1000),
-    },
-    swordsPools = {},
-    summonTimer = 0,
-    summonDelay = 0,
...
-    callBackAllTimer = 0,
-    titanSword = nil,
-    titanSwordAssembling = nil,
-    titanSwordCount = 0,
-    lastMouseMovement = {
-        x = 0,
-        y = 0,
-    },
-    swordsPerTitanLevel = 8,
-    maxTitanSwordLevel = 7,
-    titanPoolsStartIndex = 10,
-    distBetweenSwords = nil,
-    holyHandTr = nil,
-    holyHandTargetPos = nil,
-    holyHandDist = nil,
-    holyHandSpeed = nil,
-    editPointIndex = nil,
-    spinSpeeds = { -- Revolutions/sec
-        0.5,
-        0.1,
-        0.01,
-        2.0,
...
+    if v ~= 0 then
         tr = GetVehicleTransform(v)
     end
     return tr
@@ -228,8 +10,8 @@
 
 function Master.headTransform()
     local tr = GetPlayerHeadTransform()
-    local v = GetPlayerVehicle()
-    if v > 0 then
+    local v = GetPlayerVehicle(playerId)
+    if v ~= 0 then
         local driverPos = GetVehicleDriverPos(v)
         local vertDriverPos = Vec(0, driverPos[2], 0)
         local tr = TransformCopy(GetVehicleTransform(v))
@@ -246,8 +28,8 @@
 
 function Master.lookDir()
     local dir = GetPlayerHeadLookDir()
-    local v = GetPlayerVehicle()
-    if v > 0 then
+    local v = GetPlayerVehicle(playerId)
+    if v ~= 0 then
         local tr = Master.headTransform()
         dir = TransformToParentVec(tr, Vec(0, 0, -1))
     end
@@ -256,8 +38,8 @@
 
 function Master.upDir()
     local dir = GetPlayerHeadLookDir()
-    local v = GetPlayerVehicle()
-    if v > 0 then
+    local v = GetPlayerVehicle(playerId)
+    if v ~= 0 then
         local tr = Master.headTransform()
         dir = TransformToParentVec(tr, Vec(0, 1, 0))
     end
@@ -269,9 +51,8 @@
     Master.summonTimer = 0
 end
 
-
 function Master.summonSwords()
-    if Master.summonTimer > 0 then
+    if Master.summonTimer ~= 0 then
         Master.summonTimer = Master.summonTimer - GetTimeStep()
         return
     end
@@ -328,7 +109,7 @@
         -- Can only dispel non-Titan swords
         if not Master.isTitanPool(i) then
             local nbSwords = #Master.swordsPools[i]
-            if nbSwords > 0 then
+            if nbSwords ~= 0 then
                 swordInfo = Master.swordsPools[i][nbSwords]
                 Master.swordsPools[i][nbSwords] = nil
                 break
@@ -345,7 +126,7 @@
         end
 
         local vol = regGetInt('sword.soundVolume') / 100
-        if vol > 0 then
+        if vol ~= 0 then
             -- Play dispel sound
             PlaySound(Master.sounds.unsummon, pos, vol)
         end
@@ -359,7 +140,7 @@
 end
 
 function Master.dispelAllSwords()
-    if Master.dispalAllTimer > 0 then
+    if Master.dispalAllTimer ~= 0 then
         Master.dispalAllTimer = Master.dispalAllTimer - GetTimeStep()
         return
     end
@@ -385,13 +166,13 @@
     local selectedPool = Master.swordsPools[Master.attack.selected]
     -- Sea Dragon
     if Master.attack.selected == 5 then
-        if #selectedPool > 0 then
+        if #selectedPool ~= 0 then
             selectedPool[1].targetPos = tool.maxAirPoint
         end
     -- Holy Hand
     elseif Master.attack.selected == 7 then
         local headTr = Master.headTransform()
-        local camTr = GetPlayerCameraTransform()
+        local camTr = GetPlayerCameraTransform(playerId)
         if Master.holyHandTargetPos == nil then
             Master.holyHandTargetPos = TransformCopy(headTr)
         end
@@ -421,11 +202,11 @@
         --dbw("holyHandSpeed2", Master.holyHandSpeed)
     -- Endless Flow
     elseif Master.attack.selected == 8 then
-        if #selectedPool > 0 then
+        if #selectedPool ~= 0 then
             local swordInfo = selectedPool[1]
             local playerCenter = Master.centerTransform().pos
             local headTr = Master.headTransform()
-            local camTr = GetPlayerCameraTransform()
+            local camTr = GetPlayerCameraTransform(playerId)
             if swordInfo.aimDist == nil then
                 swordInfo.aimDist = tool.aimDist
                 local minAimDist = Master.distBetweenSwords * 2
@@ -516,11 +297,11 @@
         end
     -- Titan Hand, Titan Disk
     elseif (Master.attack.selected == Master.titanPoolsStartIndex+7) or (Master.attack.selected == Master.titanPoolsStartIndex+8) then
-        if #selectedPool > 0 then
+        if #selectedPool ~= 0 then
             local swordInfo = selectedPool[1]
             local lastTr = swordInfo.pointsBuffer[#swordInfo.pointsBuffer]
             local headTr = Master.headTransform()
-            local camTr = GetPlayerCameraTransform()
+            local camTr = GetPlayerCameraTransform(playerId)
             if swordInfo.aimDist == nil then
...
-    if Master.attackTimer > 0 then
+    if Master.attackTimer ~= 0 then
         Master.attackTimer = Master.attackTimer - GetTimeStep()
         return
     end
@@ -684,7 +465,7 @@
     -- Reset Titan Hand, Titan Disk
     for i=15,16 do
         local selectedPool = Master.swordsPools[i]
-        if #selectedPool > 0 then
+        if #selectedPool ~= 0 then
             local swordInfo = selectedPool[1]
             swordInfo.aimDist = nil
         end
@@ -699,7 +480,7 @@
     -- Can only call back swords not in idle pool
     for i=nbPools-1,1,-1 do
         local nbSwords = #Master.swordsPools[i]
-        if nbSwords > 0 then
+        if nbSwords ~= 0 then
             swordInfo = Master.swordsPools[i][nbSwords]
             -- Set sword in flight state
             swordInfo.state = "fly"
@@ -732,7 +513,7 @@
         if #swordInfo.pointsBuffer > 1 then
             local playerCenter = Master.centerTransform().pos
             local headTr = Master.headTransform()
-            local camTr = GetPlayerCameraTransform()
+            local camTr = GetPlayerCameraTransform(playerId)
...
@@ -776,7 +557,7 @@
 ...
 function Master.callBackAllSwords()
-    if Master.callBackAllTimer > 0 then
+    if Master.callBackAllTimer ~= 0 then
         Master.callBackAllTimer = Master.callBackAllTimer - GetTimeStep()
         return
     end
@@ -812,7 +593,7 @@
         local sword = Sword.spawn(targetTr)
         if sword ~= nil then
             Master.titanSword = Sword.makeSwordInfo(sword)
-            if vol > 0 then
+            if vol ~= 0 then
                 -- Play spawn sound
                 PlaySound(Master.sounds.summon, targetTr.pos, vol)
             end
@@ -868,7 +649,7 @@
         end
     end
...
-    if vol > 0 then
+    if vol ~= 0 then
         local levelFlipped = Master.maxTitanSwordLevel-lastLevel+1
         local pitchBase = levelFlipped - ((Master.maxTitanSwordLevel+1) / 2)
         local pitch = pitchBase
@@ -968,7 +749,7 @@
 
     local center = Sword.getCenter(titanSwordInfo.sword)
     local vol = regGetInt('sword.soundVolume') / 100
-    if vol > 0 then
+    if vol ~= 0 then
         local level = Master.getTitanSwordLevel()
         local levelFlipped = Master.maxTitanSwordLevel-level+1
         local pitchBase = levelFlipped - ((Master.maxTitanSwordLevel+1) / 2)
@@ -1016,7 +797,7 @@
         local nbPools = #Master.swordsPools
         for i=Master.titanPoolsStartIndex,(nbPools-1) do
             local nbSwords = #Master.swordsPools[i]
-            if nbSwords > 0 then
+            if nbSwords ~= 0 then
                 titanSwordInfo = Master.swordsPools[i][nbSwords]
                 if remove then
                     Master.swordsPools[i][nbSwords] = nil
@@ -1469,7 +1250,7 @@
                     if (placementInfo.height > 0) and (placementInfo.curY >= placementInfo.height) then
                         placementInfo.stepDir = "down"
                     elseif placementInfo.curY <= 0 then
-                        if placementInfo.height > 0 then
+                        if placementInfo.height ~= 0 then
                             placementInfo.stepDir = "up"
                         end
                         if placementInfo.height ~= 1 then
@@ -1880,7 +1661,7 @@
             if not swordInfo.spawnComplete then
                 swordInfo.spawnComplete = true
                 local vol = regGetInt('sword.soundVolume') / 100
-                if vol > 0 then
+                if vol ~= 0 then
                     -- Play spawn sound at new location
                     PlaySound(Master.sounds.summon, targetTr.pos, vol)
                 end
@@ -2709,12 +2490,12 @@
 function Master.updateVehicleCollision()
     local currentVehicle = 0
     if regGetBool('sword.noclipDrivenVehicle') then
-        currentVehicle = GetPlayerVehicle()
+        currentVehicle = GetPlayerVehicle(playerId)
     end
     if regGetBool('sword.noclipClosestVehicle') then
         local vehicles = FindVehicles(nil, true)
-        if #vehicles > 0 then
...
+            local playerPos = GetPlayerTransform(playerId).pos
             ...
             for i=1,#vehicles do
@@ -2782,10 +2563,10 @@
     local crouchPressed = InputDown(GetString("options.input.keymap.crouch"))
     local movementPressed = InputDown(GetString("options.input.keymap.up")) or InputDown(GetString("options.input.keymap.down"))
                         or InputDown(GetString("options.input.keymap.left")) or InputDown(GetString("options.input.keymap.right"))
-    local playerTr = GetPlayerTransform()
+    local playerTr = GetPlayerTransform(playerId)
     local targetTr = TransformCopy(playerTr)
     targetTr.pos = VecAdd(targetTr.pos, Vec(0, -0.1, 0))
-    local playerVel = GetPlayerVelocity()
+    local playerVel = GetPlayerVelocity(playerId)
     -- Activate mount if pressing jump while moving down
     if Master.swordMount == nil then
         if mountPressed and (not unmountPressed) and (playerVel[2] < 0) and tool.active() then
@@ -2800,13 +2581,13 @@
         end
     else
         -- Deactivate mount if pressing crouch while jump is pressed
-        if (mountPressed and unmountPressed) or (GetPlayerVehicle() > 0) then
+        if (mountPressed and unmountPressed) or (GetPlayerVehicle(playerId) > 0) then
             Delete(Master.swordMount.sword)
             Master.swordMount = nil
             return
         end
         -- Or if player died
...
+        if GetPlayerHealth(playerId) <= 0 then
             ...
             return
@@ -2827,16 +2608,16 @@
         newVel = VecFlatten(newVel)
         stabilize = stabilize + 1
     end
-    local playerFullTr = GetPlayerTransform(true)
+    local playerFullTr = GetPlayerTransform(playerId, true)
     -- If no movement at all, make sure player is static
     if (stabilize == 2) and (Master.stablePos ~= nil) then
-        SetPlayerTransform(Transform(Master.stablePos, playerFullTr.rot), true)
+        SetPlayerTransform(playerId, Transform(Master.stablePos, playerFullTr.rot), true)
     else
         Master.stablePos = playerFullTr.pos
     end
     -- If no movement on some axis, reduce speed on those
-    if stabilize > 0 then
-        SetPlayerVelocity(newVel)
+    if stabilize ~= 0 then
+        SetPlayerVelocity(playerId, newVel)
     end
     -- Anticipate velocity
     targetTr.pos = VecAdd(targetTr.pos, VecScale(newVel, GetTimeStep()))
@@ -2866,4 +2647,5 @@
     local p1 = trPath[1].pos
     length = length + VecDist(p0, p1)
     return length
-end+end
+
...
+#version 2
 function modReset()
     ...
     -- Sword
-    regSetBool('sword.debugMode'     , false)
-    regSetInt('sword.soundVolume'    , 50)
-    regSetBool('sword.showCounts'    , false)
+    regSetBool('sword.debugMode'     , false, true)
+    regSetInt('sword.soundVolume'    , 50, true)
+    regSetBool('sword.showCounts'    , false, true)
 
     -- Skin
-    regSetString('sword.blade.material'   , "metal")
-    regSetInt('sword.blade.color.r'       , 150)
-    regSetInt('sword.blade.color.g'       , 150)
-    regSetInt('sword.blade.color.b'       , 150)
+    regSetString('sword.blade.material'   , "metal", true)
+    regSetInt('sword.blade.color.r'       , 150, true)
+    regSetInt('sword.blade.color.g'       , 150, true)
+    regSetInt('sword.blade.color.b'       , 150, true)
     regClearKey('sword.blade.color.h')
     regClearKey('sword.blade.color.s')
     regClearKey('sword.blade.color.v')
-    --regSetString('sword.blade.texture'    , "none")
-    --regSetInt('sword.blade.textureOpacity', 0)
-    regSetInt('sword.blade.reflective'    , 100)
-    regSetInt('sword.blade.roughness'     , 0)
-    regSetInt('sword.blade.metallic'      , 100)
-    regSetInt('sword.blade.emissive'      , 1)
-
-    regSetString('sword.runes.material'   , "metal")
-    regSetInt('sword.runes.color.r'       , 127)
-    regSetInt('sword.runes.color.g'       , 127)
-    regSetInt('sword.runes.color.b'       , 255)
+    --regSetString('sword.blade.texture'    , "none", true)
+    --regSetInt('sword.blade.textureOpacity', 0, true)
+    regSetInt('sword.blade.reflective'    , 100, true)
+    regSetInt('sword.blade.roughness'     , 0, true)
+    regSetInt('sword.blade.metallic'      , 100, true)
+    regSetInt('sword.blade.emissive'      , 1, true)
+
+    regSetString('sword.runes.material'   , "metal", true)
+    regSetInt('sword.runes.color.r'       , 127, true)
+    regSetInt('sword.runes.color.g'       , 127, true)
+    regSetInt('sword.runes.color.b'       , 255, true)
     regClearKey('sword.runes.color.h')
     regClearKey('sword.runes.color.s')
     regClearKey('sword.runes.color.v')
-    --regSetString('sword.runes.texture'    , "none")
-    --regSetInt('sword.runes.textureOpacity', 0)
-    regSetInt('sword.runes.reflective'    , 100)
-    regSetInt('sword.runes.roughness'     , 0)
-    regSetInt('sword.runes.metallic'      , 100)
-    regSetInt('sword.runes.emissive'      , 100)
-
-    regSetString('sword.hilt.material'   , "metal")
-    regSetInt('sword.hilt.color.r'       , 197)
-    regSetInt('sword.hilt.color.g'       , 175)
-    regSetInt('sword.hilt.color.b'       , 128)
+    --regSetString('sword.runes.texture'    , "none", true)
+    --regSetInt('sword.runes.textureOpacity', 0, true)
+    regSetInt('sword.runes.reflective'    , 100, true)
+    regSetInt('sword.runes.roughness'     , 0, true)
+    regSetInt('sword.runes.metallic'      , 100, true)
+    regSetInt('sword.runes.emissive'      , 100, true)
+
+    regSetString('sword.hilt.material'   , "metal", true)
+    regSetInt('sword.hilt.color.r'       , 197, true)
+    regSetInt('sword.hilt.color.g'       , 175, true)
+    regSetInt('sword.hilt.color.b'       , 128, true)
     regClearKey('sword.hilt.color.h')
     regClearKey('sword.hilt.color.s')
     regClearKey('sword.hilt.color.v')
-    --regSetString('sword.hilt.texture'    , "none")
-    --regSetInt('sword.hilt.textureOpacity', 0)
-    regSetInt('sword.hilt.reflective'    , 100)
-    regSetInt('sword.hilt.roughness'     , 0)
-    regSetInt('sword.hilt.metallic'      , 100)
-    regSetInt('sword.hilt.emissive'      , 1)
-
-    regSetBool('sword.particle.enabled'      , true)
-    regSetInt('sword.particle.color.r'       , 127)
-    regSetInt('sword.particle.color.g'       , 127)
-    regSetInt('sword.particle.color.b'       , 255)
-    regSetInt('sword.particle.color.a'       , 255)
+    --regSetString('sword.hilt.texture'    , "none", true)
+    --regSetInt('sword.hilt.textureOpacity', 0, true)
+    regSetInt('sword.hilt.reflective'    , 100, true)
+    regSetInt('sword.hilt.roughness'     , 0, true)
+    regSetInt('sword.hilt.metallic'      , 100, true)
+    regSetInt('sword.hilt.emissive'      , 1, true)
+
+    regSetBool('sword.particle.enabled'      , true, true)
+    regSetInt('sword.particle.color.r'       , 127, true)
+    regSetInt('sword.particle.color.g'       , 127, true)
+    regSetInt('sword.particle.color.b'       , 255, true)
+    regSetInt('sword.particle.color.a'       , 255, true)
     regClearKey('sword.particle.color.h')
     regClearKey('sword.particle.color.s')
     regClearKey('sword.particle.color.v')
-    regSetInt('sword.particle.glow'          , 100)
-    regSetString('sword.particle.type'       , 'plain')
-    regSetString('sword.particle.tile'       , 'snow')
-    regSetBool('sword.particle.rainbow'      , false)
-
-    regSetBool('sword.stanceNoclip'        , false)
-    regSetBool('sword.noclipDrivenVehicle' , true)
-    regSetBool('sword.noclipClosestVehicle', false)
-    regSetBool('sword.mountEnabled'        , true)
-    regSetBool('sword.holyHandFixed'       , true)
-    regSetBool('sword.holyHandNoPitch'     , true)
-    regSetBool('sword.holyHandTrajectory'  , true)
-    regSetBool('sword.titanSwordFreeze'    , true)
-    regSetBool('sword.piercingTip'         , false)
-    regSetBool('sword.explosiveTip'        , false)
+    regSetInt('sword.particle.glow'          , 100, true)
+    regSetString('sword.particle.type'       , 'plain', true)
+    regSetString('sword.particle.tile'       , 'snow', true)
+    regSetBool('sword.particle.rainbow'      , false, true)
+
+    regSetBool('sword.stanceNoclip'        , false, true)
+    regSetBool('sword.noclipDrivenVehicle' , true, true)
+    regSetBool('sword.noclipClosestVehicle', false, true)
+    regSetBool('sword.mountEnabled'        , true, true)
+    regSetBool('sword.holyHandFixed'       , true, true)
+    regSetBool('sword.holyHandNoPitch'     , true, true)
+    regSetBool('sword.holyHandTrajectory'  , true, true)
+    regSetBool('sword.titanSwordFreeze'    , true, true)
+    regSetBool('sword.piercingTip'         , false, true)
+    regSetBool('sword.explosiveTip'        , false, true)
 
     -- Key bindings
     regInitKey('key.selectStance', "y")
@@ -109,21 +110,22 @@
...
# Migration Report: scripts\sword.lua
...
```diff
--- original/scripts\sword.lua
+++ patched/scripts\sword.lua
@@ -1,12 +1,4 @@
-Sword = {}
-Sword.info = {
-    texturesIndex = {},
...
-
+#version 2
 function Sword.spawn(spawnTr, level)
     -- Reverse mapping for texture indexes (index starts at 0)
     -- (done here to handle quicksave reload properly)
@@ -417,7 +409,7 @@
         ratio = 1
     end
     targetTr.rot = QuatSlerp(targetTr.rot, targetRot, ratio)
-    if offsetRot > 0 then
+    if offsetRot ~= 0 then
         --local angle = VecAngleBetween(VecForward(swordTr.rot), VecForward(finalTr.rot))
         --DebugWatch("angle", angle)
         --local aimRot = QuatSlerp(swordTr.rot, finalTr.rot, maxAngle/90)
@@ -495,7 +487,7 @@
 
         local swordVel = GetBodyVelocity(swordInfo.sword)
         local nextSwordCenter = VecAdd(swordCenter, VecScale(swordVel, dt))
-        local playerVel = GetPlayerVelocity()
+        local playerVel = GetPlayerVelocity(playerId)
         local nextPlayerCenter = VecAdd(playerCenter, VecScale(playerVel, dt))
         local willCollide = VecDist(nextSwordCenter, nextPlayerCenter) <= (playerRadius + swordRadius)
 
@@ -591,7 +583,6 @@
     Sword.rejectSwords()
     return QueryRaycast(origin, direction, maxDist, radius, rejectTransparent)
 end
-
 
 function Sword.processTipEffect(swordInfo, prevTr, nextTr)
     local isPiercing = regGetBool('sword.piercingTip')
...
-
-    input = {
-        didSummon = function() return tool.active() and InputPressed(regGetString('key.summon')) end,
-        didStopSummoning = function() return tool.active() and InputReleased(regGetString('key.summon')) end,
-        isSummoning = false,
-        didDispel = function() return tool.active() and InputPressed(regGetString('key.unsummon')) end,
-        didStopDispelling = function() return tool.active() and InputReleased(regGetString('key.unsummon')) end,
-        isDispelling = false,
-        didAttack = function() return tool.active() and InputPressed(regGetString('key.attack')) end,
-        didStopAttacking = function() return tool.active() and InputReleased(regGetString('key.attack')) end,
-        isAttacking = false,
-        didCall = function() return tool.active() and InputPressed(regGetString('key.call')) end,
-        didStopCalling = function() return tool.active() and InputReleased(regGetString('key.call')) end,
-        isCalling = false,
-        isAssembling = function() return tool.active() and InputDown(regGetString('key.assemble')) end,
-        didSplit = function() return tool.active() and InputPressed(regGetString('key.split')) end,
-    },
-
-    setup = {
-        name = 'ascended_sword_master',
-        title = 'Ascended Sword Master',
-        voxPath = '',
-    },
-
-    active = function()
-        return GetString('game.player.tool') == tool.setup.name and (GetPlayerVehicle() == 0)
-    end,
-
-    init = function(enabled)
-        RegisterTool(tool.setup.name, tool.setup.title, tool.setup.voxPath)
-        SetBool('game.tool.'..tool.setup.name..'.enabled', enabled or true)
-    end,
-}
-
+#version 2
 function tool.run()
     -- local tr = GetPlayerHeadTransform()
     -- local tr2 = GetPlayerEyeTransform()
@@ -126,7 +81,7 @@
     
     -- Get cursor position at all times (even if tool not active)
     local maxDist = 1000000
-    local camTr = GetPlayerCameraTransform()
+    local camTr = GetPlayerCameraTransform(playerId)
     local aimDir = TransformToParentVec(camTr, Vec(0, 0, -1))
     tool.aimDir = aimDir
     local hit, dist, normal, shape = Sword.trace(camTr.pos, tool.aimDir, maxDist)
@@ -181,8 +136,8 @@
 
 function tool.fixVoid()
     
-    local playerTr = GetPlayerTransform(true)
-    local playerVel = GetPlayerVelocity()
+    local playerTr = GetPlayerTransform(playerId, true)
+    local playerVel = GetPlayerVelocity(playerId)
     --DebugWatch("playerTr", playerTr)
     --DebugWatch("playerVel", playerVel)
     local reachedVoid = tool.isInvalidNumber(playerVel[1]) or tool.isInvalidNumber(playerVel[2]) or tool.isInvalidNumber(playerVel[3])
@@ -193,10 +148,10 @@
     if reachedVoid then
         DebugWatch("Welcome to the void, this is a bug", "please restart your game to fix it")
         Master.stablePos = nil
-        --SetPlayerTransform(tool.voidBackup.tr, true)
-        --SetPlayerVelocity(tool.voidBackup.vel)
-        --local newTr = GetPlayerTransform(true)
-        --DebugPrint("Reached void, restaured tr={"..VecStr(newTr.vec)..","..QuatStr(newTr.rot).."}, vel="..VecStr(GetPlayerVelocity()))
+        --SetPlayerTransform(playerId, tool.voidBackup.tr, true)
+        --SetPlayerVelocity(playerId, tool.voidBackup.vel)
+        --local newTr = GetPlayerTransform(playerId, true)
+        --DebugPrint("Reached void, restaured tr={"..VecStr(newTr.vec)..","..QuatStr(newTr.rot).."}, vel="..VecStr(GetPlayerVelocity(playerId)))
     else
         --tool.voidBackup.tr = TransformCopy(playerTr)
         --tool.voidBackup.vel = VecCopy(playerVel)
@@ -205,14 +160,8 @@
...
+end
+
 function tool.anim.init()
     -- TODO animate player?
 end
@@ -247,7 +196,7 @@
         local footRTr, footRLen = tool.anim.getBoneInfo(animator, footR, localForwardAxis)
         local footL = "foot_l"
         local footLTr, footLLen = tool.anim.getBoneInfo(animator, footL, localForwardAxis)
-        local playerFootTr = GetPlayerTransform()
+        local playerFootTr = GetPlayerTransform(playerId)
         local playerForward = VecForward(playerFootTr.rot)
         -- Put right foot slightly in front and centered under body
         local rightTr = TransformCopy(playerFootTr)
@@ -314,8 +263,8 @@
     local armLowerLTr, armLowerLLen = tool.anim.getBoneInfo(animator, armLowerL, "x")
     local armUpperR = "arm_upper_r"
     local armUpperRTr, armUpperRLen = tool.anim.getBoneInfo(animator, armUpperR, "x")
-    local playerFootTr = GetPlayerTransform()
-    local playerVel = GetPlayerVelocity()
+    local playerFootTr = GetPlayerTransform(playerId)
+    local playerVel = GetPlayerVelocity(playerId)
     local playerForward = VecForward(playerFootTr.rot)
     -- Put left hand always behind back
     local centerTr, stomachLen = tool.anim.getBoneInfo(animator, "chest", "x")
@@ -506,4 +455,5 @@
     local boneBody = GetBoneBody(animator, boneName)
     local sizes = Sword.getBodySizes(boneBody)
     return sizes
-end+end
+
...
-
-materials = {"none", "glass", "rock", "dirt", "wood", "plaster", "metal", "masonry", "foliage", "plastic", "heavymetal", "ice", "unphysical", "hardmetal", "hardmasonry"}
-
-textures = {"none", "ground", "road", "grass", "stains", "scorched", "cracked", "muddy", "rusted", "sand", "concrete", "planks", "puddles", "cement", "water", "flat", "painted", "ragged", "soaked", "marshy", "gravel", "asphalt", "impacts"}
-
-particleTiles = {'smoke', 'thrunder', 'bubbles', 'dust', 'ball', 'fire', 'square', 'none', 'snow', 'none2', 'none3', 'none4', 'hay', 'water', 'leaf', 'wave'}
-
-particleTypes = {'plain', 'smoke'}
-
-options_tabs_render = {
-
-    Master = function()
...
-            do UiPush()
-
-                ui.checkBox.create('Stance swords noclip all objects', 'sword.stanceNoclip')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Swords noclip driven vehicle', 'sword.noclipDrivenVehicle')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Swords noclip closest vehicle', 'sword.noclipClosestVehicle')
-                ui.padding.create(0, 54)
-
-                UiColor(0.6,0.6,0.6, 1)
-                UiText("It is advised to set 'Options > Input > Head bob'\nto 0% to use Sword Mount in first person")
-                ui.padding.create(0, 70)
-
-                ui.checkBox.create('Sword Mount enabled', 'sword.mountEnabled')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Titan Sword freeze when reaching target', 'sword.titanSwordFreeze')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-
-                ui.checkBox.create('Holy Hand swords face away from player', 'sword.holyHandFixed')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Holy Hand swords ignore pitch', 'sword.holyHandNoPitch')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Show Holy Hand trajectory', 'sword.holyHandTrajectory')
-                ui.padding.create(0, 64)
-
-                UiColor(1, 0.6, 0.6, 1)
-                UiText("CAUTION: piercing/explosive tip can cause a lot of lag")
-                ui.padding.create(0, 70)
-
-                ui.checkBox.create('Swords have piercing tip', 'sword.piercingTip')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Swords have explosive tip', 'sword.explosiveTip')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-
-                ui.checkBox.create('Debug Mode', 'sword.debugMode')
-                ui.padding.create(0, 64)
-
-                ui.slider.create('Sound volume', 'sword.soundVolume', '%', 0, 100, nil, nil, nil, nil, true)
-                ui.padding.create(0, 30)
-
-                ui.checkBox.create('Show swords counts', 'sword.showCounts')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-            do UiPush()
-
-                uiDrawTexturePicker("blade", "Blade")
-
-            UiPop() end
-
-            do UiPush()
...
-
-                uiDrawTexturePicker("runes", "Runes")
-
-            UiPop() end
-
-            do UiPush()
...
-                UiFont('bold.ttf', 32)
-                UiAlign('left middle')
-                UiText("Sword Particles")
-                ui.padding.create(0, 50)
-
-                ui.checkBox.create('Enabled', 'sword.particle.enabled')
-                ui.padding.create(0, 84)
-            
-                ui.colorPicker.create('Color', 'sword.particle.color', nil, nil, nil, true, true)
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Glow', 'sword.particle.glow', '%', 0, 100, nil, nil, nil, nil, true)
-                ui.padding.create(0, 30)
-
-                ui.checkBox.create('Rainbow', 'sword.particle.rainbow')
-                ui.padding.create(0, 64)
-            
-                ui.slider.create('Tile', 'sword.particle.tile', '', nil, nil, nil, nil, nil, nil, nil, particleTiles)
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Type', 'sword.particle.type', '', nil, nil, nil, nil, nil, nil, nil, particleTypes)
-                ui.padding.create(0, 30)
-
-            UiPop() end
-
...
-
-            UiText('CONTROLS')
-            ui.padding.create(0, 15)
-            UiFont('regular.ttf', font_normal)
-            ui.keyBinding.create('Select Attack', 'key.selectAttack', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Select Stance', 'key.selectStance', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Summon swords', 'key.summon', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Dispel sword', 'key.unsummon', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Attack', 'key.attack', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Call back sword', 'key.call', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Assemble Titan Sword', 'key.assemble', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Split Titan Sword', 'key.split', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Summon Sword Mount', 'key.mount', true)
-            ui.padding.create(0, 50)
-            ui.keyBinding.create('Dispel Sword Mount', 'key.unmount', true)
-            ui.padding.create(0, 50)
...
-            UiFont('regular.ttf', font_normal)
-            ui.padding.create(0, 50)
-            UiText('- Swords are unbreakable and very heavy')
-            ui.padding.create(0, 50)
-            UiText('- Swords won\'t collide with each other and try not to collide with the player')
-            ui.padding.create(0, 50)
-            UiText('- Swords will hang near you in the Stance pattern once summoned')
-            ui.padding.create(0, 50)
-            UiText('- Swords from you Stance can be used to Attack or to assemble a Titan Sword')
-            ui.padding.create(0, 50)
-            UiText('- Some Attacks will stay active even if you change Attack or tool, until you call back the sword')
-            ui.padding.create(0, 50)
-            UiText('- Spawning too many Swords will lag your game, and eventually crash it (use that dispel button)')
-            UiColor(0.6,0.6,0.6, 1)
...
-}
 ...
 function uiDrawTexturePicker(key, name)
     local w = 350
@@ -449,7 +223,6 @@
...
---- Draw spell type above tool name.
 function uiDrawIcons()
 
     function getLevelColors(level, maxLevel)
@@ -554,7 +326,7 @@
         UiTranslate(0, -imgH*1/2)
 
         UiPush()
-            if Master.stance.highlightTimer > 0 then
+            if Master.stance.highlightTimer ~= 0 then
                 local a = Master.stance.highlightTimer
                 UiColor(1, 1, 1, a)
                 UiImageBox("MOD/img/selectionHalo.png", imgW*2, imgH*2, 1,1)
@@ -577,7 +349,7 @@
         UiTranslate(-imgW * 1.25, 0)
 
         UiPush()
-            if Master.attack.highlightTimer > 0 then
+            if Master.attack.highlightTimer ~= 0 then
                 local a = Master.attack.highlightTimer
                 UiColor(1, 1, 1, a)
                 UiImageBox("MOD/img/selectionHalo.png", imgW*2, imgH*2, 1,1)
@@ -685,7 +457,7 @@
             hoveredSegment = math.floor((angle * nbSegments) / (2 * math.pi)) + 1
             if hoveredSegment ~= lastHoveredSegment then
                 local vol = regGetInt('sword.soundVolume') / 100
-                if vol > 0 then
+                if vol ~= 0 then
                     UiSound("MOD/snd/hover.ogg", vol, rdmf(0.5, 1.5))
                 end
...
---- Manage when to open and close the stance menu.
 function uiManageStanceWheel()
 
     if tool.active() then
@@ -782,7 +552,7 @@
                 Master.stance.next = 0
                 Master.stance.highlightTimer = 1
                 local vol = regGetInt('sword.soundVolume') / 100
-                if vol > 0 then
+                if vol ~= 0 then
                     UiSound("MOD/snd/abilityChanged.ogg", vol)
                 end
             end
@@ -792,7 +562,6 @@
...
---- Manage when to open and close the attacks menu.
 function uiManageAttackWheel()
 
     if tool.active() then
@@ -813,7 +582,7 @@
                 Master.attack.next = 0
                 Master.attack.highlightTimer = 1
                 local vol = regGetInt('sword.soundVolume') / 100
-                if vol > 0 then
+                if vol ~= 0 then
                     UiSound("MOD/snd/abilityChanged.ogg", vol)
...
@@ -828,21 +597,6 @@
     return UI_GAME or UI_STANCE or UI_ATTACK
...
-ui.colorPicker = {}
 ...
 function ui.colorPicker.create(title, registryPath, w, h, fontSize, useAlpha, hsvMode)
 
@@ -1120,9 +852,9 @@
             -- Init hsv colors if none defined
             if not regHasKey(registryPath..'.h') then
                 local hsv = RGBToHSV(Vec(r, g, b))
-                regSetInt(registryPath..'.h', hsv[1]*360)
-                regSetInt(registryPath..'.s', hsv[2]*100)
-                regSetInt(registryPath..'.v', hsv[3]*100)
+                regSetInt(registryPath..'.h', hsv[1]*360, true)
+                regSetInt(registryPath..'.s', hsv[2]*100, true)
+                regSetInt(registryPath..'.v', hsv[3]*100, true)
             end
         end
     UiPop() end
@@ -1141,9 +873,9 @@
             regGetInt(registryPath..'.s')/100.0,
             regGetInt(registryPath..'.v')/100.0)
         local newRgb = HSVToRGB(newHsv)
-        regSetInt(registryPath..'.r', newRgb[1]*255)
-        regSetInt(registryPath..'.g', newRgb[2]*255)
-        regSetInt(registryPath..'.b', newRgb[3]*255)
+        regSetInt(registryPath..'.r', newRgb[1]*255, true)
+        regSetInt(registryPath..'.g', newRgb[2]*255, true)
+        regSetInt(registryPath..'.b', newRgb[3]*255, true)
     else
         -- Red/Green/Blue sliders
         ui.slider.create('', registryPath..'.r', 'Red', 0, 255, w, h, fontSize, true, true)
@@ -1159,8 +891,6 @@
     end
...
-			end
-			xScale = info.xScale or xScale
-			yScale = info.yScale or yScale
-			DrawFunction = info.DrawFunction or (info.writeZ == false and DebugLine or DrawLine)
-		end
-
-		local points = {}
-		for i = 0, sides - 1 do
-			points[i + 1] = TransformToParentPoint( transform, Vec( math.sin( offset + i * interval ) * radius * xScale, 0,
-			                                                        math.cos( offset + i * interval ) * radius * yScale) )
-			if i > 0 then
-				DrawFunction( points[i], points[i + 1], r, g, b, a )
-			end
-		end
-		if arc then
-			points[#points + 1] = TransformToParentPoint( transform, Vec( math.sin( offset + sides * interval ) * radius * xScale, 0,
-			                                                              math.cos( offset + sides * interval ) * radius * yScale) )
