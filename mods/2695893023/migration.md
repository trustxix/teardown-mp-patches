...
+        if not sounds or not sounds.play or not sounds.play.pour then
+            initSounds()
+            initTimers()
+        end
+        runTimers()
...
+       if not regGetBool('perfo.renderSlimeParticles') then
+           Slime.slimes.effects.renderSlimesIdleSimple()
+       end
+
...
-    end,
-
-    -- Creates a slime projectile.
-    createShot = function()
-        local toolTr = TransformCopy(GetBodyTransform(GetToolBody()))
-        toolTr.pos = TransformToParentPoint(toolTr, Vec(0,0.1,0))
-
...
-        end
-        dbl(toolTr.pos, targetPos, 1, 1, 1, 0.5)
...
-                math.random()*spreadMult))
-
-        createProj(toolTr, projectiles, projPresets.motherSlime)
-
-    end,
-
-    reset = function()
-        Slime_slimesList = {}
-        projectiles = {}
-        dbp('Slimes have been reset.')
-        beep()
-    end,
-
-    half = function()
-        Slime.slimes.colony.markSlimesForRemoval()
-        projectiles = {}
-        dbp('Half of the slimes were removed.')
-        beep()
-    end,
-
-    limit = function()
-        local limit = regGetInt('perfo.slimesMaxPopulation')
-        if limit == 0 then
-            limit = 3000
-        else
-            limit = limit * 0.9
-        end
-        regSetInt('perfo.slimesMaxPopulation', limit)
-        dbp('Slime population limit set to ' .. limit)
-        beep()
-        Gun.actions.limitTime = GetTime()
-    end,
-
-    endLimit = function()
-        if GetTime() - Gun.actions.limitTime >= 1 then
-            regSetInt('perfo.slimesMaxPopulation', 0)
-            dbp('Slime population limit reset')
-            beep()
-        end
-    end,
-
...
+#version 2
 function modReset()
     ...
     -- Tool
-    regSetFloat('tool.pour.gravity' , 0.01)
-    regSetFloat('tool.pour.rate'    , 1600)
-    regSetFloat('tool.pour.spread'  , 10)
-    regSetFloat('tool.pour.velocity', 0.5)
-    regSetBool('tool.debugMode'     , false)
-    regSetBool('tool.hide'          , false)
+    regSetFloat('tool.pour.gravity' , 0.01, true)
+    regSetFloat('tool.pour.rate'    , 1600, true)
+    regSetFloat('tool.pour.spread'  , 10, true)
+    regSetFloat('tool.pour.velocity', 0.5, true)
+    regSetBool('tool.debugMode'     , false, true)
+    regSetBool('tool.hide'          , false, true)
 
     -- Slime
-    regSetFloat('slime.eatRadius'       , 0.1)
-    regSetInt('slime.duplicationRate'   , 1)
-    regSetFloat('slime.eatDelay'        , 0.2)
-    regSetFloat('slime.jumpDistance'    , 1)
-    regSetFloat('slime.color.r'         , 130)
-    regSetFloat('slime.color.g'         , 122)
-    regSetFloat('slime.color.b'         , 248)
-    regSetFloat('slime.color.a'         , 127)
-    regSetFloat('slime.glow'            , 1)
-    regSetBool('slime.soundOn'          , true)
-    regSetBool('slime.scaleWithRadius'  , false)
-    regSetFloat('slime.size'            , 0.2)
-    regSetFloat('slime.lifeDuration'    , 0)
-    regSetBool('slime.hiveMind'         , false)
-    regSetBool('slime.eatPlayer'        , false)
-    regSetBool('slime.mimetic'          , false)
-    regSetBool('slime.drown'            , false)
-    regSetString('slime.eatHardness'    , "Hard")
+    regSetFloat('slime.eatRadius'       , 0.1, true)
+    regSetInt('slime.duplicationRate'   , 1, true)
+    regSetFloat('slime.eatDelay'        , 0.2, true)
+    regSetFloat('slime.jumpDistance'    , 1, true)
+    regSetFloat('slime.color.r'         , 130, true)
+    regSetFloat('slime.color.g'         , 122, true)
+    regSetFloat('slime.color.b'         , 248, true)
+    regSetFloat('slime.color.a'         , 127, true)
+    regSetFloat('slime.glow'            , 1, true)
+    regSetBool('slime.soundOn'          , true, true)
+    regSetBool('slime.scaleWithRadius'  , false, true)
+    regSetFloat('slime.size'            , 0.2, true)
+    regSetFloat('slime.lifeDuration'    , 0, true)
+    regSetBool('slime.hiveMind'         , false, true)
+    regSetBool('slime.eatPlayer'        , false, true)
+    regSetBool('slime.mimetic'          , false, true)
+    regSetBool('slime.drown'            , false, true)
+    regSetString('slime.eatHardness'    , "Hard", true)
 
     -- Performance
-    regSetBool('perfo.particleTypeSmoke'     , true)
-    regSetBool('perfo.renderSlimeParticles'  , true)
-    regSetFloat('perfo.killToMaintainFPS'    , 0)
-    regSetInt('perfo.slimesMaxPopulation'    , 500)
-    regSetInt('perfo.slimesMaxDuplication'   , 100)
-    regSetBool('perfo.killSlimeAfterLastDup' , false)
-    regSetInt('perfo.slimesMaxGeneration'    , 0)
-    regSetBool('perfo.killStackedSlimes'     , true)
-    regSetBool('perfo.preventDup'            , false)
-    regSetBool('perfo.eatOneAtATime'         , false)
-    regSetBool('perfo.gooMode'               , false)
-    regSetBool('perfo.eatOnlyFirst'          , false)
-    regSetBool('perfo.freezeWhenEating'      , false)
-    regSetBool('perfo.noEatingWhileMoving'   , false)
+    regSetBool('perfo.particleTypeSmoke'     , true, true)
+    regSetBool('perfo.renderSlimeParticles'  , true, true)
+    regSetFloat('perfo.killToMaintainFPS'    , 0, true)
+    regSetInt('perfo.slimesMaxPopulation'    , 500, true)
+    regSetInt('perfo.slimesMaxDuplication'   , 100, true)
+    regSetBool('perfo.killSlimeAfterLastDup' , false, true)
+    regSetInt('perfo.slimesMaxGeneration'    , 0, true)
+    regSetBool('perfo.killStackedSlimes'     , true, true)
+    regSetBool('perfo.preventDup'            , false, true)
+    regSetBool('perfo.eatOneAtATime'         , false, true)
+    regSetBool('perfo.gooMode'               , false, true)
+    regSetBool('perfo.eatOnlyFirst'          , false, true)
+    regSetBool('perfo.freezeWhenEating'      , false, true)
+    regSetBool('perfo.noEatingWhileMoving'   , false, true)
...
# Migration Report: scripts\slime.lua
...
```diff
--- original/scripts\slime.lua
+++ patched/scripts\slime.lua
@@ -1,8 +1,4 @@
-Slime = {}
-Slime.slimes = {} -- Holds common data for all slimes.
...
+#version 2
 function Slime.run()
     ...
     -- Check if there is at least one slime eating the designated shape
@@ -118,11 +114,6 @@
     slime.color.a = a
 end
...
-Slime.slimes.colony = {}
-
---- Create a slime object and store it in the list of slimes.
 function Slime.slimes.colony.create(tr, parent)
 
     local generation = parent and (parent.generation + 1) or 1
@@ -176,7 +167,6 @@
 
 end
 
---- Spawn a slime into the world.
 function Slime.slimes.colony.spawn(pos, parent)
...
---- Mark a slime for removal to safely remove it near the end of the frame.
 function Slime.slimes.colony.markSlimeForRemoval(slime)
     slime.removeSlime = true
     dbp('Slime marked for removal: ' .. slime.id .. ' ' ..sfnTime())
 end
 
---- Mark half of the slimes for removal.
 function Slime.slimes.colony.markSlimesForRemoval(percent)
     percent = percent or 0.5
     local nbSlimes = #Slime_slimesList
     local nbSlimesToDelete = math.floor(nbSlimes * percent)
-    if nbSlimesToDelete > 0 then
+    if nbSlimesToDelete ~= 0 then
         for i = 1, nbSlimesToDelete do
             Slime.slimes.colony.markSlimeForRemoval(Slime_slimesList[i])
         end
     end
 end
 
---- Mark slimes attached to the same voxel for removal.
 function Slime.slimes.colony.removeStackedSlimes()
     local attachedSlimesSet = {}
     for i = #Slime_slimesList, 1, -1 do
@@ -227,8 +214,6 @@
     end
 end
 
-
---- Safely delete all slimes that are marked for removal.
 function Slime.slimes.colony.removeMarkedSlimes()
 
     TableRemove(Slime_slimesList, function(t, i, j)
@@ -238,7 +223,6 @@
     
 end
 
---- Get a valid spawn or jump position for a slime
 function Slime.slimes.colony.getSpawnPos(center, radius)
 
     local spawnPos = getRandPointOnSphere(center, radius)
@@ -258,13 +242,6 @@
...
-
-
-Slime.slimes.physics = {}
-
----Process the physics of a single slime.
 function Slime.slimes.physics.process(slime)
 
     if slime.sticky.shape == nil then -- Right after gas projectile hits something.
@@ -294,11 +271,6 @@
     dbw('SLIME '.. slime.id ..' attached to voxel ', slime.sticky.shapeVoxelIndex and VecStr(slime.sticky.shapeVoxelIndex) or "nil")
 
 end
-
-
-Slime.slimes.physics.sticky = {}
-Slime.slimes.physics.sticky.bodiesEaten = {}
-Slime.slimes.physics.sticky.bodiesEatenOnce = {}
 
 function Slime.slimes.physics.sticky.setShape(slime, shape, hitPoint)
 
@@ -367,7 +339,6 @@
     return GetShapeMaterialAtIndex(slime.sticky.shape, v[1], v[2], v[3]) == ''
 end
 
---- Check the surroundings of a slime and attach it to very close objects.
 function Slime.slimes.physics.sticky.dripAndStick(slime)
 
     --- If single shape to eat and shape is no longer there, kill slime.
@@ -426,25 +397,12 @@
...
-Slime.slimes.hunger = {}
-
-Slime.slimes.hunger.shapeToEat = nil
-Slime.slimes.hunger.lastStaticShapeEaten = nil
-Slime.slimes.hunger.shapeStillThere = false
-Slime.slimes.hunger.foodSources = {}
-Slime.slimes.hunger.nextFoodSources = {}
-
---- Processes the hunger of a slime.
 function Slime.slimes.hunger.process(slime)
 
     Slime.slimes.hunger.eat(slime)
 
 end
 
--- Eat when slime is sticked to something and eat timer is over.
 function Slime.slimes.hunger.eat(slime)
     -- Slime is sticked to something and is allowed to eat it
     if slime.sticky.shape ~= nil then
@@ -509,7 +467,7 @@
             end
             local voxelsDeleted = MakeHole(point, softRadius, mediumRadius, hardRadius, not regGetBool('slime.soundOn'))
             -- If eat was successful (voxels were deleted by MakeHole)
-            if voxelsDeleted > 0 then
+            if voxelsDeleted ~= 0 then
                 eatSuccess = true
                 slime.foodEaten = slime.foodEaten + 1
                 -- Duplicate slime if current slime ate enough food
@@ -547,11 +505,11 @@
                 -- If eating player
                 if regGetBool('slime.eatPlayer') then
                     local playerHead = GetPlayerEyeTransform().pos
-                    local playerFeet = GetPlayerTransform().pos
+                    local playerFeet = GetPlayerTransform(playerId).pos
                     local eatSpotToPlayer = VecSub(playerFeet, point)
                     local flatDistToPlayer = VecLength(VecFlatten(eatSpotToPlayer))
                     if flatDistToPlayer <= eatRadius and point[2] <= (playerHead[2] + eatRadius) and point[2] >= (playerFeet[2] - eatRadius) then
-                        SetPlayerHealth(GetPlayerHealth() - 0.1)
+                        SetPlayerHealth(playerId, GetPlayerHealth(playerId) - 0.1)
                     end
                 end
             end
@@ -567,7 +525,6 @@
...
---- If hive mind is active, try to jump in the direction of a known food source
 function Slime.slimes.hunger.tryJumpToFoodSource(slime)
     local nbFoodSources = #Slime.slimes.hunger.foodSources
     if (not regGetBool('slime.hiveMind')) or nbFoodSources == 0 then
@@ -579,7 +536,6 @@
     return true
 end
 
---- Returns if the colony is overpopulated
 function Slime.slimes.hunger.shouldSkipDuplication()
     -- Skip if goo mode is active
     if regGetBool('perfo.gooMode') then
@@ -607,13 +563,6 @@
     -- Else duplication can happen
     return false
 end
-
-
...
-
-
-Slime.slimes.lifetime = {}
 
 function Slime.slimes.lifetime.process(slime)
     -- Life duration of 0 is unlimited
@@ -626,12 +575,6 @@
     end
 end
...
-
-
-Slime.slimes.effects = {}
-
 function Slime.slimes.effects.process()
...
---- Draw ui dots instead of particles based on.
 function Slime.slimes.effects.renderSlimesIdleSimple()
...
@@ -11,3 +8,4 @@
 function initTimers()
     timers.gun = { shoot = { time = 0, delay = 60 / regGetFloat('tool.pour.rate') } }
 end
+
...
-            didHalf = function() return tool.tool.active() and InputPressed('l') end,
-            isShooting = function() return tool.tool.active() and InputDown('lmb') end,
-            didLimit = function() return tool.tool.active() and InputPressed('m') end,
-            endLimit = function() return tool.tool.active() and InputReleased('m') end,
-        },
-
-        setup = {
-            name = 'slime',
-            title = 'Hungry Slimes',
-            voxPath = 'MOD/vox/slime.vox',
-        },
-
-        active = function()
...
-            do UiPush()
-
-                ui.slider.create('Throw Gravity', 'tool.pour.gravity', nil, 0, 0.1)
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Throw RPM (Slimes per second)', 'tool.pour.rate', 'RPM', 120, 2400)
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Throw Velocity', 'tool.pour.velocity', 'm/s', 0.01, 1)
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Throw Spread', 'tool.pour.spread', nil, 0, 100)
-                ui.padding.create(0, 30)
-
-            UiPop() end
-
...
-
-                ui.checkBox.create('Hide tool', 'tool.hide')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-            do UiPush()
-
-                ui.slider.create('Eat Delay', 'slime.eatDelay', 'Seconds', 0, 5)
-                ui.padding.create(0, 44)
-
-                ui.slider.create('Eat Radius', 'slime.eatRadius', 'Meters', 0.1, 5)
-                ui.padding.create(0, 44)
-
-                ui.slider.create('Food for Duplication', 'slime.duplicationRate', 'Food eaten', 1, 100, nil, nil, nil, nil, true)
-                ui.padding.create(0, 44)
-
-                ui.slider.create('Jump Distance', 'slime.jumpDistance', 'Meters', 0, 10)
-                ui.padding.create(0, 44)
-
-                ui.slider.create('Life duration (0 = infinite)', 'slime.lifeDuration', 'Seconds', 0, 60)
-                ui.padding.create(0, 44)
-
-                ui.checkBox.create("Goo mode (Slimes don't duplicate and don't starve to death)", 'perfo.gooMode')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create("Hive mind (Slimes share food spots with each other and never starve)", 'slime.hiveMind')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
...
-
-                ui.checkBox.create('Sound', 'slime.soundOn')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Use Eat Radius for Size', 'slime.scaleWithRadius')
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create('Can eat player', 'slime.eatPlayer')
-                ui.padding.create(0, 64)
-
-            UiPop() end
-
-            do UiPush()
-
-                ui.padding.create(900, 0)
-
-                ui.slider.create('Slimes can eat', 'slime.eatHardness', 'Materials', nil, nil, nil, nil, nil, nil, nil, {"Soft", "Medium", "Hard"})
-                ui.padding.create(0, 30)
-
-                ui.slider.create('Size', 'slime.size', 'Meters', 0.1, 10)
-                ui.padding.create(0, 30)
-                UiColor(0.6,0.6,0.6, 1)
-                UiAlign('left middle')
-                UiText('Note: Max 3m with High quality Slime Particles, see Performance tab')
-                ui.padding.create(0, 30)
-                
-                ui.slider.create('Glow', 'slime.glow', '', 0, 5)
-                ui.padding.create(0, 64)
-
-                ui.colorPicker.create('Color', 'slime.color', nil, nil, nil, true)
-                ui.padding.create(0, 64)
-
-                ui.checkBox.create("Mimetic Slimes (Slimes copy the color of the object they stick to)", 'slime.mimetic')
-                do UiPush()
-                    ui.padding.create(150, 24)
-                    UiColor(0.6,0.6,0.6, 1)
-                    UiAlign('left middle')
-                    UiText('Note: Set Glow at 0 for perfect color match')
-                UiPop() end
-                ui.padding.create(0, 64)
-
-            UiPop() end
...
-
-            do UiPush()
-                ui.checkBox.create('Render Slime Particles', 'perfo.renderSlimeParticles')
-            UiPop() end
-            do UiPush()
-                ui.padding.create(300, 0)
-                ui.checkBox.create('High quality Slime Particles', 'perfo.particleTypeSmoke')
-            UiPop() end
-            ui.padding.create(0, 100)
-
-            ui.slider.create('Limit Slime population to maintain FPS', 'perfo.killToMaintainFPS', 'FPS', 0, 120)
-            ui.padding.create(0, 30)
...
-            ui.padding.create(0, 64)
-
-            ui.slider.create('Slime max population (0 = infinite)', 'perfo.slimesMaxPopulation', 'Slimes', 0, 3000, nil, nil, nil, nil, true)
-            ui.padding.create(0, 30)
-            UiAlign('left middle')
-            local population = Slime and #Slime_slimesList or 0
-            UiText('Population: '..population..' Slimes')
-            ui.padding.create(0, 64)
-
-            ui.checkBox.create('Prevent duplication instead of killing old Slimes when limiting population', 'perfo.preventDup')
-            ui.padding.create(0, 64)
-            
-            do UiPush()
-                ui.checkBox.create('Freeze objects being eaten', 'perfo.freezeWhenEating')
-                ui.padding.create(0, 60)
-                UiColor(1, 0.6, 0.6, 1)
-                UiAlign('left middle')
-                UiText('CAUTION: Freezing objects will result in some weird floating parts')
-                ui.padding.create(0, 64)
-            UiPop() end
-            do UiPush()
-                ui.padding.create(300, 0)
-                ui.checkBox.create('Auto-kill Slimes attached to the same block', 'perfo.killStackedSlimes')
-            UiPop() end
-            ui.padding.create(0, 64)
-
-        UiPop() end
...
-            ui.padding.create(800, 0)
-
-            ui.slider.create('Each Slime can do (100 = infinite)', 'perfo.slimesMaxDuplication', 'Duplications', 0, 100, nil, nil, nil, nil, true)
-            ui.padding.create(0, 64)
-
-            do UiPush()
-                ui.padding.create(400, 0)
-                ui.checkBox.create('Slimes drown in water', 'slime.drown')
-            UiPop() end
-            ui.checkBox.create('Slime dies after last duplication', 'perfo.killSlimeAfterLastDup')
-            ui.padding.create(0, 64)
-
-            ui.slider.create('Slimes cannot duplicate if born at generation (0 = infinite)', 'perfo.slimesMaxGeneration', '', 0, 100, nil, nil, nil, nil, true)
-            ui.padding.create(0, 64)
-
-            ui.checkBox.create('Do as Mom said (Slimes eats one object at a time)', 'perfo.eatOneAtATime')
-            ui.padding.create(0, 64)
-
-            ui.checkBox.create("Picky eaters (Slimes only eat the first thing they touch)", 'perfo.eatOnlyFirst')
-            ui.padding.create(0, 64)
-
-            ui.checkBox.create("Don't eat and drive (Slimes stop eating when their food is moving)", 'perfo.noEatingWhileMoving')
-            ui.padding.create(0, 64)
-
-        UiPop() end
-
...
-        UiText('Thanks a lot to Cheejins for his "Gas Can" mod, which was used as a base for this mod!')
...
-        ui.padding.create(0, 50)
-        UiFont('regular.ttf', font_normal)
-        UiText('[Left Click]: Spawn Slimes')
-        ui.padding.create(0, 50)
-        UiText('[L]: Kill half of the Slimes')
-        ui.padding.create(0, 50)
-        UiText('[K]: Kill all Slimes')
-        ui.padding.create(0, 50)
-        UiText('[M]: Tap to reduce max Slimes on map')
-        ui.padding.create(0, 50)
-        UiText('[M]: Hold to reset max Slimes on map')
-        ui.padding.create(0, 50)
-
-        UiFont('bold.ttf', 32)
-        UiText('NOTES')
-        ui.padding.create(0, 50)
-        UiFont('regular.ttf', font_normal)
-        UiText('- Slimes can be seen as better fire (that can burn anything), or as sticky acid.')
-        ui.padding.create(0, 50)
-        UiText('- Slimes will attempt to duplicate after eating if they have enough food.')
-        ui.padding.create(0, 50)
-        UiText('- Playing with the options to make the Slimes dupliate faster will slow down your game.')
-        ui.padding.create(0, 50)
-        UiText('- Slimes seems to lag a lot more when eating large free-floating objects (eg: boats). Fixed by the "Freeze objects being eaten" option.')
-        ui.padding.create(0, 50)
-
-    end,
-
...
@@ -797,4 +489,5 @@
         ui.slider.create('', registryPath..'.a', 'Alpha', 0, 255, w, h, fontSize, true, true)
     end
...
+
+function VecPrint(vec, decimals, label)
         DebugPrint(VecStr(vec, decimals, label))
     end
