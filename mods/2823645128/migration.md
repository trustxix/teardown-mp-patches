...
-#include "hrafnscripts/aiscriptsslave.lua"
...
-	thrusterHumLoop2 = LoadLoop("MOD/snd/slavejett.ogg", 40.0)
...
-	hrafnSpeed = 15
-	height = math.random(8,10)	--height above ground, i originally wanted 6, TODO: editor-set height
...
-	coreEulerX = clamp(coreEulerX,-20,5) --limit pitch
...
-	--smooth rotation
-	hrafnTransform.rot = QuatSlerp(hrafnTransform.rot,hrafnTargetRot,0.02)
-	
-	--searchlight control
...
# Migration Report: hrafn\hrafnair.lua
...
```diff
--- original/hrafn\hrafnair.lua
+++ patched/hrafn\hrafnair.lua
@@ -1,322 +1,310 @@
-#include "script/common.lua"
-#include "hrafnscripts/bodyscripts.lua"
...
-	thrusterHumLoop2 = LoadLoop("MOD/snd/tiesfx.ogg", 10.0)
-	heardSound = LoadSound("robot/alert.ogg")
-	heardSound = LoadSound("snd/alertclicking.ogg")
-	shieldBreakSound = LoadSound("alarm3-loop.ogg")
-	shieldBreakSound2 = LoadSound("alarm1.ogg")
...
-	hrafnVel = Vec() --for actual velocity
-	hrafnSpeed = 15
-	height = math.random(7,10)	--height above ground, i originally wanted 6, TODO: editor-set height
-	toHeight = 0 --after accounting for ground
-	averageSurroundingHeight = 0 
-	
-	--ai awareness parameters
...
-	hrafnTargetRot = QuatLookAt(hrafnTransform.pos,lookPos)
-	local coreEulerX, coreEulerY, coreEulerZ = GetQuatEuler(hrafnTargetRot) --break quat into euler
-	coreEulerX = clamp(coreEulerX,-5,2) --limit pitch
-	hrafnTargetRot = QuatEuler(coreEulerX,coreEulerY,coreEulerZ) --rebuild quat with modified pitch
-	
-	--searchlight control 
-	local aimPos = VecCopy(lookPos)
...
# Migration Report: hrafn\hrafnintrotest.lua
...
```diff
--- original/hrafn\hrafnintrotest.lua
+++ patched/hrafn\hrafnintrotest.lua
@@ -1,321 +1,310 @@
-#include "script/common.lua"
-#include "hrafnscripts/bodyscripts.lua"
-#include "hrafnscripts/aiscriptstietest.lua"
-#include "hrafnscripts/flightscripts.lua"
-#include "hrafnscripts/weaponscripts2.lua"
-#include "hrafnscripts/utilities.lua"
-
...
# Migration Report: hrafn\hrafnscripts\aiscriptsslave.lua
...
```diff
--- original/hrafn\hrafnscripts\aiscriptsslave.lua
+++ patched/hrafn\hrafnscripts\aiscriptsslave.lua
@@ -1,4 +1,4 @@
---shields 
+#version 2
 function initShields()
...
# Migration Report: hrafn\hrafnscripts\aiscriptstie.lua
...
```diff
--- original/hrafn\hrafnscripts\aiscriptstie.lua
+++ patched/hrafn\hrafnscripts\aiscriptstie.lua
@@ -1,4 +1,4 @@
---shields 
+#version 2
 function initShields()
...
# Migration Report: hrafn\hrafnscripts\aiscriptstietest.lua
...
```diff
--- original/hrafn\hrafnscripts\aiscriptstietest.lua
+++ patched/hrafn\hrafnscripts\aiscriptstietest.lua
@@ -1,4 +1,4 @@
---shields 
+#version 2
 function initShields()
...
+#version 2
 function initAutoCannon()
 	...
 	autoCannonSound = LoadSound("MOD/snd/slaveshoot4.ogg", 25.0)
@@ -67,7 +56,6 @@
 	laserReady = false
 end
...
# Migration Report: hrafn\hrafnscripts\weaponscripts1.lua
...
```diff
--- original/hrafn\hrafnscripts\weaponscripts1.lua
+++ patched/hrafn\hrafnscripts\weaponscripts1.lua
@@ -1,15 +1,4 @@
-autoCannonShellHandler = {
-	shellNum = 1,
-	shells = {},
...
+#version 2
 function initAutoCannon()
 	autoCannonSettings = FindLocation("autocannonsettings")
 	autoCannonSound = LoadSound("MOD/snd/blaster.ogg", 25.0)
@@ -66,7 +55,6 @@
 	laserReady = false
 end
...
# Migration Report: script\atst.lua
...
```diff
--- original/script\atst.lua
+++ patched/script\atst.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
-	huntSound = LoadSound("--MOD/strider/snd/blaster.ogg")
...
-	end
-	
-	robot.stunned = clamp(robot.stunned - dt, 0.0, 600.0)
-	if robot.stunned > 0 then
-		head.seenTimer = 0
-		weaponsReset()
-		return
...
# Migration Report: script\atst2.lua
...
```diff
--- original/script\atst2.lua
+++ patched/script\atst2.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
# Migration Report: script\door13.lua
...
```diff
--- original/script\door13.lua
+++ patched/script\door13.lua
@@ -1,60 +1,63 @@
-function init()	
...
+    	if not broken1 or broken2 then
+
+    	if GetPlayerInteractShape(playerId) == doorconsole and InputPressed("interact") then
+    		pos = GetShapeWorldTransform(door13).pos	
+    		door13On = true
+    		motorOn = true
+    		PlaySound(motorSound, pos)
...
# Migration Report: script\emperor.lua
...
```diff
--- original/script\emperor.lua
+++ patched/script\emperor.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
-
-	patrolLocations = FindLocations("patrol")
-	shootSound = LoadSound("MOD/main/snd/blastersfx.ogg", 6.0)
...
-	huntSound = LoadSound("MOD/main/snd/laughing.ogg", 17.0)
-	idleSound = LoadSound("MOD/main/snd/villager/midle0.ogg")
-	fireLoop = LoadLoop("MOD/main/snd/lightning.ogg", 3.0)
-	fireLoop2 = LoadLoop("MOD/main/snd/sparks.ogg", 3.0)
-	fireLoop3 = LoadLoop("MOD/main/snd/sparks2.ogg", 3.0)
-	disableSound = LoadSound("robot/disable0.ogg")
-	crush = LoadSound("MOD/main/snd/clsh08.ogg", 9.0)
-	swing = LoadSound("MOD/main/snd/swng07.ogg", 9.0)
-    fdeath = LoadSound("MOD/main/snd/pdeath.ogg", 4.0)
...
-		SetTag(robot.body, "disabled")
-		robot.enabled = false
-		PlaySound(fdeath, robot.bodyCenter, 1.0, false)
-	end
-	
-	if IsPointInWater(robot.bodyCenter) then
-		--PlaySound(disableSound, robot.bodyCenter, 1.0, false)
...
-	end
-	
-	robot.stunned = clamp(robot.stunned - dt, 0.0, 2.0)
-	if robot.stunned > 0 then
-		head.seenTimer = 0
-		weaponsReset()
-		return
...
-          
-	UiPush()
-		local path = string.format("MOD/logo.png")
-
...
-		UiImageBox(path, screenW, screenH, 1, 1)  
-	UiPop() 
-
+function client.tick(dt)
+    local playerId = GetLocalPlayer()
...
# Migration Report: script\fxmy.lua
...
```diff
--- original/script\fxmy.lua
+++ patched/script\fxmy.lua
@@ -1,89 +1,7 @@
-#include "script/common.lua"
-
+#version 2
...
# Migration Report: script\infoscreen.lua
...
```diff
--- original/script\infoscreen.lua
+++ patched/script\infoscreen.lua
@@ -1,43 +1,45 @@
...
# Migration Report: script\jedi.lua
...
```diff
--- original/script\jedi.lua
+++ patched/script\jedi.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
-	swing = LoadSound("MOD/main/snd/swng07.ogg", 9.0)
-    fdeath = LoadSound("MOD/main/snd/ldeath.ogg", 4.0)
-        mdeath = LoadSound("MOD/main/snd/villager/mdeath0.ogg")
-
-
-end
...
# Migration Report: script\jedio.lua
...
```diff
--- original/script\jedio.lua
+++ patched/script\jedio.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
-	chargeLoop = LoadLoop("robot/charge-loop.ogg", 8.0)
-	alertSound = LoadSound("MOD/main/snd/villager/m1.ogg", 9.0)
-	huntSound = LoadSound("MOD/main/snd/hello.ogg", 9.0)
-	idleSound = LoadSound("MOD/main/snd/villager/midle0.ogg")
-	fireLoop = LoadLoop("tools/blowtorch-loop.ogg")
-	disableSound = LoadSound("robot/disable0.ogg")
-	crush = LoadSound("MOD/main/snd/clsh08.ogg", 9.0)
-	insound = LoadSound("MOD/main/snd/in01.ogg", 9.0)
-	swing = LoadSound("MOD/main/snd/swng07.ogg", 9.0)
-    fdeath = LoadSound("MOD/main/snd/kdeath.ogg", 99.0)
-        mdeath = LoadSound("MOD/main/snd/villager/mdeath0.ogg")
-
-
-end
...
-		if config.canSeePlayer and head.canSeePlayer or robot.canSensePlayer then
-			stackClear()
-			PlaySound(huntSound, robot.bodyCenter, 9999.0, false)
-			stackPush("hunt")
-		end
-	end
-	
...
# Migration Report: script\rebel.lua
...
```diff
--- original/script\rebel.lua
+++ patched/script\rebel.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
# Migration Report: script\sith.lua
...
```diff
--- original/script\sith.lua
+++ patched/script\sith.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
# Migration Report: script\strider.lua
...
```diff
--- original/script\strider.lua
+++ patched/script\strider.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
...
# Migration Report: script\trooper.lua
...
```diff
--- original/script\trooper.lua
+++ patched/script\trooper.lua
@@ -1,84 +1,7 @@
-#include "script/common.lua"
-
-------------------------------------------------------------------------------------
