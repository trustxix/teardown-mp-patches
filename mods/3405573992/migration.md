...
-	RegisterTool("rmwmp5", "MP5", "MOD/prefab/minigun.xml")
-	SetBool("game.tool.rmwmp5.enabled", true)
-
-	angle = 0
-	angVel = 0
-	coolDown = 0
...
-	SetToolHaptic("rmwmp5", toolHaptic);
-
-	
-	oldPipePos = Vec()
-	particleTimer = 0
...
+tion draw()
 ...
 if GetString("game.player.tool") == "rmwmp5" and not reloading and not attachmentmenu and GetBool("game.thirdperson") and not low then
...
+    RegisterTool("rmwmp5", "MP5", "MOD/prefab/minigun.xml")
+    SetBool("game.tool.rmwmp5.enabled", true, true)
+    angle = 0
+    angVel = 0
+    coolDown = 0
+    smoke = 0
